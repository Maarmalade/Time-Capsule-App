...
// in time_capsule/test/services/public_folder_service_test.dart.
...
import 'package:time_capsule/models/media_file_model.dart' as _i9;
import 'package:time_capsule/services/media_service.dart' as _i8;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockMediaService extends _i1.Mock implements _i8.MediaService {
  MockMediaService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Future<String> createMedia(String? folderId, _i9.MediaFileModel? media) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Stream<List<_i9.MediaFileModel>> streamMedia(String? folderId) =>
      (super.noSuchMethod(
            Invocation.method(#streamMedia, [folderId]),
            returnValue: _i5.Stream<List<_i9.MediaFileModel>>.empty(),
          )
          as _i5.Stream<List<_i9.MediaFileModel>>);
